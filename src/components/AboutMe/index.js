...
import "./styles.scss";
import Resume from "../../fixtures/Keith Li-resume.pdf";
  ...
  return (
    <div className="about-me-wrapper">
      ...
      <div className="information-wrapper">
        ...
        <div className="about-me-note-keith">
          Passionate about life and coding & A big fan of Toronto Raptors!!
        </div>
        <a
          className="about-me-resume-keith"
          href={Resume}
          download="Keith Li-resume.pdf"
        >
          Download My Resume (PDF, 80KB)
        </a>
      </div>
    </div>
  );
