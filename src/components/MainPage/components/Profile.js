...
import { mdiBlurRadial, mdiForum, mdiBellAlert, mdiMenu } from "@mdi/js";
...
const Profile = (props) => {
  ...
  return (
    <div
      className={
        "profile-wrapper " + (minimized ? "profile-wrapper-expand" : "")
      }
    >
      <h4
        className={
          "profile-title " + (minimized ? "profile-title-minimized" : "")
        }
      >
        AWESOME DASH
      </h4>
      ...
      <h4 className="profile-name">
        {firstName && lastName ? `${firstName} ${lastName}` : "John Joe"}
      </h4>
